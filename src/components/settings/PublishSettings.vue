        ...
        >
          ...
          <template v-if="publishType === 'pose'">
            <el-form-item label="发布话题">
              <el-input
                v-model="poseTopic"
                placeholder="/move_base_simple/goal"
              />
            </el-form-item>
            <el-alert
              title="点击两次设置导航目标：第一次设置位置，第二次设置方向"
              type="info"
              :closable="false"
              style="margin-bottom: 12px"
            />
          ...
          <template v-if="publishType === 'pose_estimate'">
            <el-form-item label="发布话题">
              <el-input
                v-model="poseEstimateTopic"
                placeholder="/initialpose"
              />
            </el-form-item>
            ...
            <el-alert
              title="点击两次设置初始位姿：第一次设置位置，第二次设置朝向"
              type="info"
              :closable="false"
              style="margin-bottom: 12px"
            />
